...
public class FermenterRecipe implements Recipe<SimpleContainer> {
    ...
    public FermenterRecipe (NonNullList<Ingredient> inputItems, ItemStack output, ResourceLocation id) {
    ...
    public static class Serializer implements RecipeSerializer<FermenterRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(fishinglife.MOD_ID, "fermenting");
        ...
        public FermenterRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ...
            return new FermenterRecipe(inputs, output, pRecipeId);
        }
