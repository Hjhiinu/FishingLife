...
public class BiomeTagPredicate {
    ...
    public static final List<TagKey<Biome>> INVALID_TYPES = Arrays.asList(BiomeTags.IS_NETHER, BiomeTags.IS_END, Tags.Biomes.IS_VOID);//Thanks to Team Metallurgy and their public minecraft mod repository
                                                                                                                                            //These codes were copied from Aquaculture2 repository
